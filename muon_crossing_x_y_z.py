...
TPC.coleção_de_luz(Muon, 0.05, ax2, x=TPC.comprimento_x, tipo='Hist')
ax2.set_xlim(0, 1000)
ax2.set_ylim(0, 1000)
ax3 = fig.add_subplot(143)
TPC.coleção_de_luz(Muon, 0.05, ax3, y=TPC.comprimento_y, tipo='Hist')
ax3.set_xlim(0, 1000)
ax3.set_ylim(0, 1000)
ax4 = fig.add_subplot(144)
TPC.coleção_de_luz(Muon, 0.05, ax4, z=TPC.comprimento_z, tipo='Hist')
ax4.set_xlim(0, 1000)
ax4.set_ylim(0, 1000)
plt.show()
